...
<body class="ipmi-login">
 ...
 'bootstrap' => $planSum['bootstrap_markers'] ?? [],
        ...
        <dt style="opacity:.75;margin:0;">Runtime debug</dt><dd style="margin:0 0 8px 0;font-size:12px;">Open the KVM link with <code>?ipmi_proxy_debug=1</code> (or <code>?debug=1</code>). Browser console: <code>[ipmi-kvm]</code> vendor progression (iLO: <code>/index.html</code> speculative flow — <code>ilo_launch_discovery_started</code>, <code>ilo_launch_surface_found</code>, <code>ilo_launch_function_invocation_*</code>, <code>ilo_launch_discovery_escalation_*</code> href-first then SPA fallback once, <code>ilo_shell_only_ui_detected</code> / <code>ilo_white_screen_stall_detected</code>, <code>ilo_launch_action_no_effect</code>, <code>ilo_launch_helper_seen_but_no_target_found</code>; SPA path: <code>ilo_application_path_loaded</code>, <code>ilo_application_loaded_shell_only</code>, <code>ilo_console_not_reached_after_application_load</code>, <code>ilo_console_module_detected</code> / <code>ilo_console_launch_action_*</code> / <code>ilo_console_content_frame_*</code>, vs <code>ilo_overview_shell_detected</code> / <code>ilo_live_console_display_visible</code>, <code>ilo_helper_activity_without_console_transition</code> / <code>ilo_helper_success_not_counted_as_console_success</code>, <code>ilo_console_readiness_verdict</code> (<code>native_console_tier_hint</code>, <code>application_loaded_shell_only</code>, <code>helper_correlated_with_visible_console</code>), <code>ilo_confirmation_*</code>, <code>ilo_strong_confirmation_rejected_shell_only</code>, <code>ilo_user_visible_console_success</code> / <code>native_console_strongly_confirmed</code> only after visible live display + relay transport). Server: <code>ilo_runtime_js_generation_{validated,invalid,fixed}</code>, iLO blank-SPA via <code>ilo_runtime_preflight_*</code>, <code>ilo_runtime_auth_refresh_*</code>, <code>ilo_runtime_request_retry</code>, <code>ilo_runtime_sse_retry</code>, <code>ilo_runtime_final_failure</code>, plus <code>ilo_console_startup_helper_*</code> for inner helpers such as <code>jnlp_template</code>. Response header <code>X-IPMI-Proxy-Debug-Log</code> includes <code>ilo_path_role</code>, <code>ilo_console_readiness_server</code> (<code>native_console_debug_verdict</code> / tier), <code>ilo_native_console_confirmation</code>, and heuristic flags (no secrets).</dd>
