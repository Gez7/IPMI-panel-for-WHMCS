...
function ipmiProxyBuildKvmRuntimeProgressHelpersJs(): string
{
    return ''
        ...
        . 'return new W0(u,p);};'
        . 'window.WebSocket.prototype=W0.prototype;'
        . 'try{var _wsk=["CONNECTING","OPEN","CLOSING","CLOSED"];for(var _wi=0;_wi<_wsk.length;_wi++){if(W0[_wsk[_wi]]!==undefined)window.WebSocket[_wsk[_wi]]=W0[_wsk[_wi]];}}catch(_wse){}'
        . '}catch(e3){}}'
        . 'kvmHookWsRelayProbe();'
