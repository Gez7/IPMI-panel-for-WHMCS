...
function ipmiProxyBuildKvmAutoLaunchPreambleJs(string $familyJs, string $planJs, string $pxJs, string $autoJs, string $dbgLit): string
{
    return '(function(){'
        ...
        . 'try{if(typeof window.addEventListener==="function"){window.addEventListener("pagehide",function(){try{kvmBugSyncTokenGlobally();kvmBugFinalizeRun({reason:"pagehide"});}catch(_ph){}},true);}}catch(_peh){}'
...
function ipmiProxyBuildIloHelperRuntimeJs(string $pxJs, string $dbgLit, ?array $kvmBuglog = null): string
{
    ...
    return '(function(){'
        ...
        . 'try{if(typeof window.addEventListener==="function"){window.addEventListener("pagehide",function(){try{kvmBugSyncTokenGlobally();kvmBugFinalizeRun({reason:"helper_pagehide"});}catch(_phh){}},true);}}catch(_pehh){}'
