...
function ipmiProxyBuildIloKvmScript(): string
{
    return 'if(FAMILY==="ilo"){'
        ...
        . 'if((n%4)===0&&iloSt.specShell){try{var _mxTk=iloSt.__lastTick||0;var _mxWs=!!kvmIloWsTransportEvidence();var _mxLive=!!ipmiProxyIloHasLiveDisplayEvidence(window);var _mxApp=ipmiProxyIloApplicationPathLoaded();_kvmDbg("ilo_kvm_debug_matrix",{launch_function_found:iloSt.launchFunctionFound?1:0,launch_function_effective:iloSt.launchFunctionEffective?1:0,shell_path_abandoned:iloSt.shellPathAbandoned?1:0,application_navigation_committed:iloSt.appNavCommitted?1:0,application_navigation_failed:iloSt.appNavFailed?1:0,white_screen_stall:iloSt.whiteStallReported?1:0,white_screen_candidate:_mxApp&&!_mxLive&&_mxTk>20&&ipmiProxyIloLooksLikeWhiteScreenStall(_mxTk,iloSt)?1:0,live_display_visible:_mxLive?1:0,transport_started:_mxWs?1:0,strong_confirmation_ready:rf.ok?1:0,strong_confirmation_why:String(rf.why||""),shell_launch_probe_exhausted:iloSt.shellLaunchProbeExhausted?1:0});}catch(_mx){}}'
